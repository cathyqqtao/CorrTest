* mcmctree.ctl for mammal analysis (dos Reis et al. 2012):
         seed = -1
      seqfile = Database_S1_prot_corrected.phy
     treefile = cambrianTopology_fixed.nwk
      outfile = Erwin_MC2T_AR_oneCali.txt

         ndata = 1
       seqtype = 2  * 0: nucleotides; 1:codons; 2:AAs
       usedata = 2    * 0: no data; 1:seq like; 2:use in.BV; 3: out.BV
         clock = 3    * 1: global clock; 2: independent rates; 3: correlated rates
       RootAge = '>0.902<1.002'  * safe constraint on root age, used if no fossil for root.
